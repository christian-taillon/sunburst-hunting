...
Most of these NBI provided to help researchers and threat hunters can be used as high confidence. This is except the indicators provided by John Bambenek shortly after Sunburst which appears now to be unrelated to Sunburst activity or even to UNC2452. This list was dumped from [Open Source Contex Data-Library](https://oscontext.com/). It includes redirects and isn't currated to only include Sunburst content. It is not advised to use production tools to identify or scope the Sunburst indecent. The repo's name is 'research' and it may have been intended to use for just that.
